        ...
        !loading && booking.length > 0 ? (
          <ResponsiveContainer width="100%" height={300}>
            <BarChart data={booking}>
              ...
              <XAxis dataKey="BOOKING_DATE" /> {/* ใช้ BOOKING_DATE ที่สอดคล้องกับข้อมูลที่แปลงแล้ว */}
              <YAxis ticks={[5,  15, 25, 35,45]} domain={[0, 50]}  />
              <Tooltip />
              <Legend />
              <Bar dataKey="TOTAL_BOOKINGS" fill="#8884d8" /> {/* ใช้ TOTAL_BOOKINGS ที่สอดคล้องกับข้อมูลที่แปลงแล้ว */}
            </BarChart>
          </ResponsiveContainer>
        ) : (

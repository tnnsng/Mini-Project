            ...
            <div className="overflow-x-auto">
                <table className="min-w-full border-collapse border border-gray-300">
                    <thead className="bg-gray-100">
                        <tr>
                            <th className="py-3 px-4 border-b text-left font-semibold text-gray-600">รหัสพนักงาน (EMP_ID)</th>
                            <th className="py-3 px-4 border-b text-left font-semibold text-gray-600">วันที่ (DATE)</th>
                            <th className="py-3 px-4 border-b text-left font-semibold text-gray-600">ปลดล็อก</th>
                        </tr>
                    </thead>
                    <tbody>
                        {users.map((user) => (
                            user.AMOUNT >= 3 && ( // Only show rows where AMOUNT is 3
                                <tr key={user.EMP_ID} className="hover:bg-gray-50">
                                    <td className="py-4 px-4 border-b text-gray-700">{user.EMP_ID}</td>
